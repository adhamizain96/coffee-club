...
export default function GoogleReviews({ placeData }: { placeData: GooglePlaceData }) {
  if (!placeData.rating && placeData.reviews.length === 0) {
    return null;
  }
  ...
  return (
    <section className="mt-8">
      ...
      {/* Rating summary */}
      {placeData.rating && (
        <div className="flex items-center gap-3 mb-5 p-4 rounded-xl bg-stone-50 border border-stone-100">
          ...
          <div>
            ...
            {placeData.userRatingTotal && (
              <p className="text-xs text-stone-400 mt-0.5">
                {placeData.userRatingTotal.toLocaleString()} reviews on Google
              </p>
            )}
          </div>
        </div>
            ...
            >
              <div className="flex items-center gap-2 mb-1.5">
                {review.profilePhotoUrl ? (
                  ...
                  <div className="h-7 w-7 rounded-full bg-stone-200 flex items-center justify-center text-xs font-medium text-stone-500">
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-xs text-stone-400">{review.relativeTime}</span>
                  </div>
