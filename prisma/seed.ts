...
// Cafe images, indexed positionally to the `cafes` array below.
// Sources, per cafe: official cafe website, or — when the cafe's site renders
// client-side / has no usable static photo — joe.coffee, a coffee-focused
// directory whose photos are tied to specific cafe UUIDs (treated as a
// reputable directory for sourcing). Every URL was HEAD-verified (HTTP 200,
// image content-type) before commit. No stock images, no Yelp/Google user
// uploads, no AI-generated images.
//
// File-size note: keep cafe images under ~600 KB. Several CDN URLs accept a
// resize parameter — Squarespace `?format=1500w`, Shopify `?width=1024`, Wix
// `/v1/fill/w_1600,h_1067,…`. Conscious Cup's image, in particular, is 5.4 MB
// at full size — always pin it to `?width=1024` (or smaller).
const CAFE_IMAGES = [
  // 0–9: original 10 cafes
  ...
  // 10–31: suburban additions (matched per cafe by position)
  "https://backlotcoffee.com/cdn/shop/files/IMG_0914_a8a9532d-9da1-4a46-8c79-a50074dd5812.jpg?v=1720643923&width=1024", // Backlot — official
  "https://pub-ba1a74be17d7442a9f2541946eb9510e.r2.dev/shops/7b310199-11ef-4208-81c4-74f49747adeb/0.jpg", // Brothers K — joe.coffee (no static photo on official site)
  "https://pub-ba1a74be17d7442a9f2541946eb9510e.r2.dev/shops/a7dcb9e8-50de-4648-80ed-ae6a2d42b696/0.jpg", // Newport — joe.coffee (no public site found)
  "https://images.squarespace-cdn.com/content/v1/60f78c3dd364b340e4eeb15b/6477e49d-fb86-498b-b818-8e2a99fd1b56/IMG_5889+copy.jpg?format=1500w", // Reprise — official
  "https://images.squarespace-cdn.com/content/v1/645bfb42350e5177106d7bcf/1033b34c-5352-45dc-b7fe-b79d53a262e9/2021_6+coffee-53.jpg?format=1500w", // Central Station — official
  "https://d1w7312wesee68.cloudfront.net/y_crrALI_m51Dqe6cmnY56Ja5_-OzgBj9yC1OsxL69w/ext:webp/quality:85/c:1621:901:ce:197:-317/plain/s3://toast-sites-resources-prod/restaurantImages/2ffe01bb-7382-4f20-94da-4e2a15175004/92c4b43f082cbf3d97f9ffa8776dcb5a1.jpeg", // Glenview Grind — official (Toast)
  "https://images.squarespace-cdn.com/content/v1/684f87bf94db873775efc75f/46e6b35a-02af-4369-9d51-dd50bb89dc80/DSC00573.jpg?format=1500w", // Bean Bar — official
  "https://pub-ba1a74be17d7442a9f2541946eb9510e.r2.dev/shops/ed8e6a08-bc75-4e0d-8e1d-a61ce1b4cf4a/0.jpg", // Complimentary — joe.coffee (official site not reachable)
  "https://pub-ba1a74be17d7442a9f2541946eb9510e.r2.dev/shops/7108d029-ac36-43b2-bdb2-75d07fe69483/0.jpg", // Harmony — joe.coffee (site renders client-side)
  "https://pub-ba1a74be17d7442a9f2541946eb9510e.r2.dev/shops/a2e6affc-0189-4a97-b76f-9e869e1818e1/0.jpg", // Hometown — joe.coffee (site not reachable)
  "https://images.squarespace-cdn.com/content/v1/66189577ad4d344c7573bc30/53ba5019-2f0b-4c56-98c5-d1e39bc87a1b/Brian+catering.jpg?format=1500w", // Gerry's — official
  "https://two-libras.com/wp-content/uploads/2024/07/Two-Libras-Cafe-Interior-4.jpg", // Two Libras — official
  "https://pub-ba1a74be17d7442a9f2541946eb9510e.r2.dev/shops/87872285-94e4-45c2-bbaf-7e0e36aee0fb/0.jpg", // Sayfani — joe.coffee (no public site found)
  "https://consciouscup.com/cdn/shop/files/Coffee-roasting.jpg?v=1738581299&width=1024", // Conscious Cup — official
  "https://www.kribicoffee.com/cdn/shop/files/Kribi_Coffee_Company_Hero_Desktop_D_e9ef75eb-cdbf-4926-9c90-4f638f1ce376.webp?v=1765564601&width=2000", // Kribi — official
  "https://pub-ba1a74be17d7442a9f2541946eb9510e.r2.dev/shops/f6422ffe-f977-4da4-97ad-16204263d438/0.jpg", // Five & Hoek — joe.coffee (Shopify site has no cafe photo)
  "https://sparrowcoffee.com/cdn/shop/files/sparrow_naperville_beautiful_shot.jpg?v=1707449741&width=1600", // Sparrow — official
  "https://d1w7312wesee68.cloudfront.net/PtRsrq022q4CjjkCNrOcnxk5QEwa3aHYqbNncGscphU/ext:webp/quality:85/c:800:469:ce:0:-30/plain/s3://toast-sites-resources-prod/restaurantImages/698c0d28-c9a0-4f88-a85f-722e841b3307/DSC_8283.jpg", // Café La Fortuna — official (Toast)
  "https://static.wixstatic.com/media/cf3294_81d4da981d604b3586ed4c5a5b912a01~mv2.jpg/v1/fill/w_2500,h_1668,al_c/cf3294_81d4da981d604b3586ed4c5a5b912a01~mv2.jpg", // Owl & Lark — official (Wix)
  "https://pub-ba1a74be17d7442a9f2541946eb9510e.r2.dev/shops/12388d3f-eb80-4295-988e-915362c9108d/0.jpg", // Pekoe & Bean — joe.coffee (site renders client-side)
  "https://static.wixstatic.com/media/c05719_2d102dc41aa545cea51d6439a1ba4666~mv2.jpg/v1/fill/w_1600,h_1067,al_c,q_85,enc_avif,quality_auto/c05719_2d102dc41aa545cea51d6439a1ba4666~mv2.jpg", // Two Mile — official (Wix)
  "https://pub-ba1a74be17d7442a9f2541946eb9510e.r2.dev/shops/8d20540c-4a48-47bc-b6f7-e8563e9f0cc8/0.jpg", // Beverly Bakery — joe.coffee (Wix gallery has menu graphics, not cafe photos)
];
...
const cafes: CafeSeed[] = [
  ...
  // Coordinates were geocoded against the Google Maps Geocoding API — see
  // scripts/geocode-cafes.ts.
  // ---------------------------------------------------------------------------
  {
    name: "Backlot Coffee",
    description:
  ...
  },
  {
    ...
    latitude: 42.18324940000001,
    longitude: -87.7974502,
    ownerReview:
